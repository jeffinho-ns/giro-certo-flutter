  ...
  static List<MotorcycleModel> getAllMotorcycles() {
    ...
    _cachedList = [
      ...
      MotorcycleModel(
          ...
          model: 'NXR/Bros 150',
          displacement: '150 cc',
          abs: 'ABS opcional em versões mais completas'),
      MotorcycleModel(
          id: '7',
          brand: 'Honda',
          model: 'NXR/Bros 160',
      ...
      MotorcycleModel(
          ...
          displacement: '300 cc',
          abs: 'ABS em versões topo'),
      MotorcycleModel(
          id: '9',
          brand: 'Honda',
          model: 'XRE 190',
          displacement: '190 cc',
          abs: 'ABS em versões modernas'),
      MotorcycleModel(
          id: '10',
          brand: 'Honda',
          model: 'XRE 300',
      ...
      MotorcycleModel(
          ...
          model: 'YBR 125',
          displacement: '125 cc',
          abs: 'Sem ABS em versões básicas'),
      MotorcycleModel(
          id: '20',
          brand: 'Yamaha',
          model: 'YBR 150',
      ...
      MotorcycleModel(
          ...
          model: 'DK 160',
          displacement: '160 cc',
          abs: 'ABS em certas configurações'),
      MotorcycleModel(
          id: '46',
          brand: 'Haojue',
          model: 'DR 160',
      ...
      MotorcycleModel(
          id: '61',
          brand: 'Vmoto / Voltz / Watts',
          model: 'EV1',
          displacement: 'Elétrico',
          abs: 'Frenagem regenerativa / ABS em alguns'),
      MotorcycleModel(
          id: '62',
          brand: 'Vmoto / Voltz / Watts',
          model: 'W125',
